<template>
	<view class="container" style="position:static" >
		<scroll-view scroll-x="true"
					 scroll-with-animation
					 :scroll-left="scrollLeft"  style="height:76rpx;border-bottom: 1px solid #fff;width:660rpx;" @tochmove.stop="handler">
		...
		<view class="add" :style="is_H5?'top: 22rpx':'top: 18rpx'">
